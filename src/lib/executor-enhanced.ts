...
export async function executeTask(
  ...
  try {
    ...
    // github_create_issue/github_get_issues intentionally excluded: those built-ins require a raw
    // GITHUB_TOKEN and bypass the working Composio OAuth connection. Let them fall through to Composio.
    const BUILT_IN_TOOLS = ['memory_store', 'memory_recall', 'http_request', 'email_send', 'twitter_post'];
