    ...
    >
      <div className="flex items-start gap-3 p-4">
        ...
        <textarea
          ...
          rows={1}
          disabled={disabled}
          className="flex-1 bg-transparent border-0 outline-none resize-none text-foreground placeholder:text-muted-foreground min-h-[24px] max-h-[120px] font-sans"
        />
        <Button
          size="icon"
          variant="ghost"
      ...
      {isFocused && (
        <div className="absolute bottom-3 left-4 text-[10px] text-muted-foreground font-sans">
