      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-background/80 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="size-10 rounded-xl bg-slate-900 flex items-center justify-center border border-slate-800 transition-all duration-300 hover:scale-105 shadow-sm overflow-hidden">
              <Image src="/LOGO.png" alt="AgentOS" width={40} height={40} className="invert" />
            </div>
            <div 
              className={cn(
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-sm font-bold tracking-tight">AgentOS</h2>
              {isThinking && (
