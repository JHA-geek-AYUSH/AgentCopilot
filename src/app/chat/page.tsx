...
import type { ChatMessage, ToolExecutionCard } from '@/types/chat';
  ...
  const addWelcomeMessage = useCallback(() => {
    setMessages([
      ...
      },
      {
        ...
        role: 'agent',
        content: `Hey ${user?.firstName || 'there'} 👋 I'm your AgentOS agent. I can fetch your emails, manage GitHub, search the web, remember things, and more. What would you like me to do?`,
        status: 'done',
        timestamp: new Date().toISOString(),
      }
    ]);
