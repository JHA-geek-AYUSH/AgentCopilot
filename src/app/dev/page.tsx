    ...
    children: [
      {
        ...
        name: 'index.ts',
        type: 'file',
        content: `// AgentOS Dev Environment
// Start coding here!
...
`,
  ...
  },
  {
    ...
    name: 'README.md',
    type: 'file',
    content: '# AgentOS Project\n\nBuilt with AgentOS Dev Environment.',
    language: 'markdown',
  },
];
...
export default function DevPage() {
  ...
  useEffect(() => {
    ...
    xterm.writeln('\x1b[1;32m║   AgentOS Dev Terminal v1.0              ║\x1b[0m');
    xterm.writeln('\x1b[1;32m╚════════════════════════════════════════╝\x1b[0m');
    xterm.writeln('');
                  ...
                  <div className="flex flex-col items-center gap-3 p-8 bg-card border border-border/50 rounded-2xl shadow-2xl max-w-[300px] text-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        The AgentOS Agent-IDE is currently under construction. Native code editing and direct agent deployment is coming in our next major release.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Card className="p-4 mb-4 border-border/50">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium">agentos-project</h3>
